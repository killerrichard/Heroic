...
var Photos = function (_Database$Model) {
  _inherits(Photos, _Database$Model);
  ...
  _createClass(Photos, [{
    ...
    value: function author() {
      return this.belongsTo(_users2.default, 'user_id').query('columns', ['id', 'username', 'look']);
    }
  }, {
    key: 'likes',
    value: function likes() {
      return this.hasMany(_photo_likes2.default, 'photo_id').query('columns', ['photo_id']);
    }
  }, {
    key: 'tableName',
    get: function get() {
